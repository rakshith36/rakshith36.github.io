...
var App = {
  ...
  work: function(){
    ...
    this.echo();
	this.echo("|  " + commandText('Associate Peoplesoft Developer ') + "at " + commandText("Wipro Limited") + "\n|  Jun 2019 - Oct 2020");
  ...
  about: function(){
    ...
    this.echo("|  DOB:          22/04/1997 (23 y.o)");
    this.echo("|  Summary:      I am an Information Security Enthusiast who believes in sharing knowledge is the secret to get success. ");
    this.echo("|                I participate in various other InfoSec activities like HackTheBox or TryHackMe Challenges, Capture The Flag (CTF) Contest, Webinars,InfoSec seminars etc. " );
    this.echo();
  },
  ...
  skills: function(){
    ...
    this.echo("|  [[g;#B2D100;]ERP] ");
    this.echo("|  " + commandText('Peoplesoft') + "               ##[[g;#5BD100;]#########################                   ]       ##");
    this.echo("|");
  ...
  contact: function(){
    ...
    this.echo("|  " + commandText("Phone") + ":         (+91) 9035436801");
    this.echo();
  },
  credit: function(){
    this.exec('credits');
